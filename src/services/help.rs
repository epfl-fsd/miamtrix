...
pub fn get_help() -> String {
    ...
    `!schedule` [day] [<command>]       Schedules a command to run automatically at 11:30 AM on the specified day(s). Example: !schedule mon !menu hopper runs the !menu hopper command every Monday at 11:30 AM.
