...
pub fn get_help() -> String {
    ...
    `!schedule` create -d [days] -j [command]    Schedules a command to run automatically at 11:30 AM on the specified day(s). Example: `!schedule create -d mon -j !menu hopper` runs the command every Monday. Use `!schedule -h` for full details.
